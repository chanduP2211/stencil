...
@Component({
  tag: 'admin-subject-show',
  styleUrl: 'admin-subject-show.css',
  shadow: true,
})
              ...
              <ol class="body">
                ...
                <li>
                  <svg
                    ...
                    class="update"
                    viewBox="0 0 640 512"
                    onClick={this.updating.bind(this, element.subject)}
                  >
                    <path
                      fill="currentColor"
                  ...
                  <svg
                    ...
                    class="delete"
                    viewBox="0 0 24 24"
                    onClick={this.deleting.bind(this, element.subject)}
                  >
    ...
    if (this.valid) {
      this.data.map(element => {
        if (element.subject === this.id) {
          content = <admin-subject teacher_name={element.teacher} subject_name={element.subject} />;
        }
      });
    }

    if (this.check) {
      content = <admin-subject teacher_name="" subject_name="" />;
    }
    return (
