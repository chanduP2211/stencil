          ...
          <div class="table">
            {this.data.map(element => {
              if (this.id === element.rollNo) {
                ...
                return (
                  <ol class={percentage < 75 ? (percentage < 50 ? 'red body' : 'yellow body') : 'green body'}>
                    <li>{element.rollNo}</li>
                    <li>{element.name}</li>
                    <li>{element.section}</li>
                    <li>TOTAL: {element.present + element.absent}</li>
                    <li>PRESENT: {element.present}</li>
                    <li>ABSENT: {element.absent}</li>
      ...
      <div class="background">
        <div class="home">
          ...
          <div class="rotate">
            <div>
              <div class="check">
                <h1 onClick={this.showing.bind(this)}> TOTAL REPORT</h1>
              </div>
            </div>
            <div>
              <div class="check">
                <h1 onClick={this.getAttendnce.bind(this)}> TODAY REPORT</h1>
              </div>
            </div>
          </div>
          {content}
