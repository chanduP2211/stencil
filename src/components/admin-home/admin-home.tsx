       ...
       content = (
        ...
        return(
            ...
            <div class="navBar">
                <div class='main'>
                    <div class="menu_btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.6em"  onClick={this.show.bind(this)}><path fill="currentColor" d="M3 8V7h17v1H3Zm17 4v1H3v-1h17ZM3 17h17v1H3v-1Z"/></svg>
                    </div>
                    <div class="lab">
