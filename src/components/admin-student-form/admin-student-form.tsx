        ...
        return(
           ...
           <div class='background'>
            ...
            <select ref={el=>this.gender=el} >
                          ...
                          <option value="Male" selected = {this.s_gender === 'Male'}>Male</option>
                          <option value="Female" selected = {this.s_gender === 'Female'}>Female</option>
            </select>
            </div>
            <div class="ele">
            ...
            <div class="btn">
                ...
                <label onClick={this.cancelling} class='cancel'>Cancel</label>
            </div>
            </div>
            </form> 
            </div>
...
if(this.id.value === ''||this.fname.value === ''||this.lname.value === ''||this.dob.value === ''||this.gender.value === ''||this.phone.value === ''|| this.section.value === ''||this.address.value === ''){
    this.valid = false
