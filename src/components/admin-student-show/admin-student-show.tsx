     ...
     if(this.valid){
        this.data.map(element=>{
            if(this.stu_id === element.id){
                content = <admin-student s_id={element.id}  
