   ...
   if(this.valid){
     content = (
      ...
      return(
            ...
            <div class="navBar">
            <div class='main'>
              <svg xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.6em" class='menu'  preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" onClick={this.show.bind(this)}><path fill="currentColor" d="M3 8V7h17v1H3Zm17 4v1H3v-1h17ZM3 17h17v1H3v-1Z"/></svg>
