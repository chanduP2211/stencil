        ...
        return(
         ...
         <div class="parent_ele">
            ...
            <select ref={el=>this.gender=el}>
                          ...
                          <option value="Male"  selected={this.t_gender == 'Male'}>Male</option>
                          <option value="Female" selected={this.t_gender == 'Female'}>Female</option>
            </select>
            </div>
            ...
            <div class="btn">
                <button type="submit" class="submit" onClick={this.submiting.bind(this)}>Submit</button>
                <label onClick={this.cancelling.bind(this)} class='cancel'>Cancel</label>
            </div>
            </div>
            </form> 
          </div>
...
if(this.id.value === ''||this.name.value === ''||this.email.value === ''||this.gender.value === ''||this.phone.value === ''|| this.degree.value === ''||this.experience.value === ''||this.address.value === ''){
    this.valid = false
